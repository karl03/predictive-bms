...
void BattModel::SetCapacity(float new_capacity) {
    float ratio = new_capacity / capacity_;
    nominal_capacity_ = nominal_capacity_ * ratio;
    exponential_capacity_ = exponential_capacity_ * ratio;
